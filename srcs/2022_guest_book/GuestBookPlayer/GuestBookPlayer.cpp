    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_GUESTBOOKPLAYER, Window::GetInstance()->szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_GUESTBOOKPLAYER));
